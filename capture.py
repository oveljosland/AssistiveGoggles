...
def display_color_and_depth_images(camera: realsense_camera.PyRealSenseCamera):
    def run_continuous(camera: realsense_camera.PyRealSenseCamera):
        while True:
            display_color_and_depth_image(camera)
...
if __name__ == "__main__":
    ...
    display_color_and_depth_images(real_sense_camera)
